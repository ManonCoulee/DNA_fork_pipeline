def get_targets():
    ...
    if config["steps"]["scarseq"]:
        ...
        targets["readcounts"]=[
            expand(os.path.normpath(OUTPUT_DIR + "/Profiles/{sample_name}/{sample_name}_readcounts.bed"), sample_name=SAMPLE_NAME),
        ...
        targets["partition"]=[
            expand(os.path.normpath(OUTPUT_DIR + "/Profiles/{sample_name}/{sample_name}_rfd.bedgraph"),sample_name=SAMPLE_NAME),
